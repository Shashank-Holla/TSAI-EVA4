...
from gradcam.utils import find_alexnet_layer, find_vgg_layer, find_resnet_layer, find_densenet_layer, find_squeezenet_layer
...
class GradCAM(object):
    ...
    def __init__(self, model_dict, verbose=False):
        ...
        # print("The required target layer from the model",target_layer)
